...
function About() {
    return (
        <div className='bg-white h-fit w-full relative overflow-y-scroll '>
            <div className='py-14'>
                <h1 className='font-bold text-3xl text-center mt-12 fontxxx'>What Drives Us (mission & vision)</h1>
                <div className="flex lg:flex-row flex-col items-center justify-center relative p-12">
                    <div className="hover:bg-black hover:text-white bg-slate-200 w-96 lg:w-96 m-2 h-96 p-8 rounded-xl transition-all ease-in-out duration-1000">
                    ...
                    <div className="hover:bg-black hover:text-white bg-slate-200 w-96 lg:w-96 m-2 p-8 h-96 rounded-xl transition-all ease-in-out duration-1000">
