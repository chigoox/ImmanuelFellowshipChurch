                ...
                <div className="flex lg:flex-row flex-col items-center justify-center relative p-12">
                    <div className={`${color ? 'bg-blue-900' : 'hover:bg-slate-900 hover:text-white bg-slate-200'} flex-col flex  w-96 lg:w-96 m-2 p-8 rounded-xl transition-all ease-in-out duration-1000`}>
                        ...
                        <div className={`${color ? 'bg-blue-500' : ''} hover:top-5 top-0 hover:scale-105 transition-all duration-[1000ms] ease-in-out relative shadow p-4 shadow-black flex flex-col justify-center items-center h-[75%]`}>
                            ...
                            <input className='p-2 m-auto my-2 w-[90%] shadow-sm shadow-black h-12 font-bold text-black focus:scale-110 duration-500 ease-in-out transition-all' type="time" placeholder='' onChange={({ target }) => { addToDatabase('DATASTORE', 'ServiceTime', 'sundayTime', target.value) }} />
                            <label htmlFor="">Thursday time</label>
                            <input className='p-2 m-auto my-2 w-[90%] shadow-sm shadow-black h-12 font-bold text-black focus:scale-110 duration-500 ease-in-out transition-all' type="time" placeholder='Video ID2' onChange={({ target }) => { addToDatabase('DATASTORE', 'ServiceTime', 'thursdayTime', target.value) }} />
                        </div>
